...
<template>
  <section class="panel center-panel">
    <div class="content-toolbar">
      ...
      <div class="content-toolbar__group">
        <button class="btn btn--primary btn--sm" style="padding: 6px 14px; font-size: 13px;" :disabled="isDownloading" @click="downloadPng">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 4px; vertical-align: text-bottom;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
  ...
  <Teleport to="body">
    <div v-if="isEditingContent" class="content-editor-overlay" @click.self="!isChatLoading && (isEditingContent = false)">
      <div class="content-editor-modal">
        ...
        <div class="content-editor-body" style="flex: 1; display: flex; flex-direction: column; overflow: hidden; position: relative;">
          <MdEditor 
            v-model="content" 
        ...
        <div class="content-editor-footer" style="display: flex; justify-content: space-between; align-items: center;">
          <span class="content-editor-tip">支持 Markdown 语法，内容将自动拆分</span>
          <div style="display: flex; gap: 16px; align-items: center;">
            <label style="display: flex; align-items: center; gap: 6px; cursor: pointer; font-size: 14px; color: var(--primary);">
              <input type="checkbox" v-model="useAiSummary" :disabled="isChatLoading" style="accent-color: var(--primary); width: 16px; height: 16px;" />
              是否使用 AI 总结
            </label>
